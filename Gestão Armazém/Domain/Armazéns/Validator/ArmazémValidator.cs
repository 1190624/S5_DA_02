...
namespace DDDSample1.Domain.Armazéns.Validator {
    public class ArmazémValidator : IValidator {
        ...
        public bool IsValid(params Object[] listParameter) {
            ...
            if (String.IsNullOrEmpty(((String) listParameter[1])) || ((String) listParameter[2]).Length > DESIGNAÇÃO_LENGTH_MAX)
            ...
            if (((Int16) listParameter[3]) > NÚMERO_PORTA_MAX)
            ...
            if (((Double) listParameter[8]) > LATITUDE_MAX || ((Double) listParameter[9]) < LATITUDE_MIN)
